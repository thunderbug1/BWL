...
\begin{tabular}{|>{\centering\arraybackslash}p{3cm}|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{2.5cm}|}
	...
	\hline
	Finanzen \& Controlling 		&  & 2 & 4 & 3 \\ 
	\hline 
	Fremdsprachen 					&  & 2 & 2 & 2 \\
	\hline
	Marketing 						&  & 4 & 3 & 4 \\ 
	\hline 
	Software \& Hardware 			&  & 1 & 2 & 2 \\ 
	\hline 	
	Organisations- fähigkeit 		&  & 1 & 2 & 2 \\ 
	\hline	
	Personalwesen \& Entwicklung 	&  & 3 & 3 & 3 \\
	\hline
	Produktion 						&  & 3 & 3 & 2 \\
	\hline
	Projekt- management 			&  & 3 & 2 & 1 \\ 
	\hline 
	Verkauf 						&  & 4 & 3 & 2 \\ 
	\hline 
\end{tabular} 
...
\begin{tabular}{|>{\centering\arraybackslash}p{3cm}|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{2.5cm}|}
	...
	\hline 
	Anpassungs- fähigkeit 		&  & 2 & 2 & 2 \\ 
	\hline 
	Belastbarkeit 				&  & 1 & 1 & 1 \\ 
	\hline 
	Charisma 					&  & 2 & 1 & 2 \\ 
	\hline 
	Durchsetzungs- vermögen 	&  & 2 & 2 & 1 \\ 
	\hline 
	%(Selbst-) Disziplin &  &  &  &  \\ 
	%\hline
	Engagement  				&  & 1 & 1 & 1 \\  %und Einsatzbereitschaft
	\hline 
	Empathie					&  & 2 & 1 & 3 \\ 
	\hline 
	Flexibilität 				&  & 1 & 2 & 2 \\ 
	...
	%\hline 
	Kommunikations- fähigkeit 	&  & 2 & 1 & 2 \\ 
	\hline 
	Kritikfähigkeit 			&  & 2 & 2 & 1 \\ 
	\hline 
	%Kreativität &  &  &  &  \\ 
	%\hline 
	Konflikt- fähigkeit 		&  & 2 & 3 & 1 \\ 
	\hline 
	Kunden- orientierung 		&  & 2 & 2 & 2 \\ 
	\hline 
	%LEBENSLANGES LERNEN würd i fosd aussadoa, -Christopher
	Lebenslanges Lernen 		&  & 2 & 1 & 1 \\ 
	\hline 
	Menschen- kenntnis 			&  & 2 & 1 & 2 \\ 
	\hline 
	Motivation 					&  & 1 & 1 & 1 \\ 
	\hline 
	%Neugierde &  &  &  &  \\ 
	...
	Teamfähigkeit 				&  & 2 & 1 & 2 \\ 
	\hline 
	Urteilsvermögen 			&  & 1 & 2 & 2 \\ 
	\hline 
	Verhandlungs- kompetenz		&  & 2 & 2 & 2 \\ 
	\hline 
	Verantwortung 				&  & 1 & 1 & 1 \\ 
	\hline 
	Zeitmanagement 				&  & 1 & 3 & 2 \\ 
	\hline 
	Zielorientierung 			&  & 1 & 1 & 1 \\ 
	\hline 
\end{tabular} 
