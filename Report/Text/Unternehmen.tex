...
Dominik absolviert gerade den Diplomstudiengang Automatisierungstechnik an der FH Oberösterreich, Campus Wels, welchen er voraussichtlich im Juli 2018 abschließen wird. Den darauf aufbauenden Bachelorstudiengang absolvierte er ebenfalls an der FH Oberösterreich.\\ % Schulbildung und Berufserfahrung bitte noch selber ergänzen. 
...
\begin{tabular}{|>{\centering\arraybackslash}p{3cm}|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{2.5cm}|}
	...
	\hline 
	Anpassungs- fähigkeit &  & 2 &  &  \\ 
	\hline 
	Belastbarkeit &  & 1 &  &  \\ 
	\hline 
	Charisma &  & 2 &  &  \\ 
	\hline 
	Durchsetzungs- vermögen &  & 2 &  &  \\ 
	\hline 
	%(Selbst-) Disziplin &  &  &  &  \\ 
	%\hline 
	Engagement  &  & 1 &  &  \\  %und Einsatzbereitschaft
	\hline 
	Empathie &  & 2 &  &  \\ 
	\hline 
	Flexibilität &  & 1 &  &  \\ 
	...
	%\hline 
	Kommunikations- fähigkeit &  & 2 &  &  \\ 
	\hline 
	Kritikfähigkeit &  & 2 &  &  \\ 
	\hline 
	%Kreativität &  &  &  &  \\ 
	%\hline 
	Konflikt- fähigkeit &  & 2 &  &  \\ 
	\hline 
	Kunden- orientierung &  & 2 &  &  \\ 
	\hline 
